-- ALL CREDITS TO EXXTREMEWA#9394
...
local backgroundColor = Color3.fromRGB(38, 38, 48)
...
function Highlight:updateoperatorColor(new) operatorColor = new end
function Highlight:functionColor(new) functionColor = new end
function Highlight:stringColor(new) stringColor = new end
function Highlight:numberColor(new) numberColor = new end
function Highlight:booleanColor(new) booleanColor = new end
function Highlight:objectColor(new) objectColor = new end
function Highlight:defaultColor(new) defaultColor = new end
function Highlight:commentColor(new) commentColor = new end
function Highlight:lineNumberColor(new) lineNumberColor = new end
function Highlight:genericColor(new) genericColor = new end
